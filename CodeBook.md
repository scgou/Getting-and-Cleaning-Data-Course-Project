...
## Tidy Data
Details of the original raw data can be found in the section marked Raw Data (see below).

The following changes have been made to the original raw data to tidy it:

1. The subject and activity type data have been combined with the train and test data (Subject and Activity occupy the left two columns in each).
